...
class FightPair {
  constructor(fighter1, fighter2, winner) {
    __publicField(this, "fighter1");
    __publicField(this, "fighter2");
...
class FightEvent {
  constructor(date, fights) {
    __publicField(this, "date", /* @__PURE__ */ new Date());
    __publicField(this, "fights", []);
    this.date = date;
    this.fights = fights;
  }
  getFights() {
...
class Tourney {
  constructor(name, index, category, gender, fighters2, events2) {
...
const fighters = [
  new Fighter("John", "Doe", 25, 70),
  new Fighter("Alice", "Smith", 28, 65),
  new Fighter("Mike", "Johnson", 30, 80),
  new Fighter("Emily", "Brown", 23, 55),
  new Fighter("Daniel", "Wilson", 27, 75),
  new Fighter("Sarah", "Taylor", 26, 68),
  new Fighter("James", "Anderson", 29, 72),
  new Fighter("Emma", "Martinez", 31, 63),
  new Fighter("Ryan", "Thomas", 24, 77),
  new Fighter("Olivia", "Garcia", 32, 58),
  new Fighter("David", "Lopez", 33, 73),
  new Fighter("Sophia", "Hernandez", 22, 69),
  new Fighter("Michael", "Rodriguez", 34, 74),
  new Fighter("Isabella", "Gonzalez", 21, 66),
  new Fighter("Matthew", "Perez", 35, 71),
  new Fighter("Ella", "Torres", 20, 67),
  new Fighter("William", "Moore", 36, 76),
  new Fighter("Lily", "Clark", 19, 59),
  new Fighter("Benjamin", "Young", 28, 72),
  new Fighter("Sophie", "Lewis", 25, 68),
  new Fighter("Alexander", "Hall", 30, 79),
  new Fighter("Grace", "Walker", 23, 64),
  new Fighter("Henry", "King", 29, 75),
  new Fighter("Ava", "Green", 27, 70),
  new Fighter("Jacob", "Baker", 31, 65),
  new Fighter("Charlotte", "Hill", 26, 73),
  new Fighter("Daniel", "Wright", 24, 69),
  new Fighter("Mia", "Adams", 33, 60),
  new Fighter("Jack", "Nelson", 22, 78),
  new Fighter("Emily", "Evans", 32, 66),
  new Fighter("Noah", "Carter", 21, 74),
  new Fighter("Chloe", "Ward", 34, 62)
];
const events = [
  new FightEvent(
    /* @__PURE__ */ new Date("2020-01-01"),
    [
      new FightPair(fighters[0], fighters[1], fighters[0]),
      new FightPair(fighters[2], fighters[3], fighters[2]),
      new FightPair(fighters[4], fighters[5], fighters[4]),
      new FightPair(fighters[6], fighters[7], fighters[6]),
      new FightPair(fighters[8], fighters[9], fighters[8]),
      new FightPair(fighters[10], fighters[11], fighters[10]),
      new FightPair(fighters[12], fighters[13], fighters[12]),
      new FightPair(fighters[14], fighters[15], fighters[14]),
      new FightPair(fighters[16], fighters[17], fighters[16]),
      new FightPair(fighters[18], fighters[19], fighters[18]),
      new FightPair(fighters[20], fighters[21], fighters[20]),
      new FightPair(fighters[22], fighters[23], fighters[22]),
      new FightPair(fighters[24], fighters[25], fighters[24]),
      new FightPair(fighters[26], fighters[27], fighters[26]),
      new FightPair(fighters[28], fighters[29], fighters[28]),
      new FightPair(fighters[30], fighters[31], fighters[30])
    ]
  ),
  new FightEvent(
    /* @__PURE__ */ new Date("2020-02-01"),
    [
      new FightPair(fighters[0], fighters[2], fighters[0]),
      new FightPair(fighters[4], fighters[6], fighters[6]),
      new FightPair(fighters[8], fighters[10], fighters[8]),
      new FightPair(fighters[12], fighters[14], fighters[14]),
      new FightPair(fighters[16], fighters[18], fighters[16]),
      new FightPair(fighters[20], fighters[22], fighters[20]),
      new FightPair(fighters[24], fighters[26], fighters[24]),
      new FightPair(fighters[28], fighters[30], fighters[28])
    ]
  ),
  new FightEvent(
    /* @__PURE__ */ new Date("2020-03-01"),
    [
      new FightPair(fighters[0], fighters[4], fighters[4]),
      new FightPair(fighters[8], fighters[12], fighters[8]),
      new FightPair(fighters[16], fighters[20], fighters[16]),
      new FightPair(fighters[24], fighters[28], fighters[24])
    ]
  ),
  new FightEvent(
    /* @__PURE__ */ new Date("2020-04-01"),
    [
      new FightPair(fighters[4], fighters[8], fighters[4]),
      new FightPair(fighters[16], fighters[24], fighters[24])
    ]
  ),
  new FightEvent(
    /* @__PURE__ */ new Date("2020-05-01"),
    [
      new FightPair(fighters[4], fighters[24], fighters[24])
    ]
  )
];
const tourneys = [
  new Tourney("Tourney 1", 1, "Light", "male", fighters, events),
  new Tourney("Tourney 2", 2, "Heavy", "female", fighters, events),
  new Tourney("Tourney 3", 3, "Middle", "male", fighters, events)
];
...
function requireUtils() {
  ...
  function createEventListenerFunction(type) {
    return function(el, events2, handler) {
      if (!el) {
        return;
      }
  ...
  function getReferenceLineMap(containerProvider, parentSize, id) {
    ...
    Object.values(widgetPositionStore).forEach(function(_a2) {
      var x = _a2.x, y = _a2.y, w = _a2.w, h2 = _a2.h;
      referenceLine.row.push(y, y + h2, y + h2 / 2);
...
function requireHooks() {
  ...
  function initState(props, emit2) {
  ...
  function initDraggableContainer(containerRef, containerProps, limitProps, draggable, emit2, containerProvider, parentSize) {
    var x = containerProps.left, y = containerProps.top, w = containerProps.width, h2 = containerProps.height, dragging = containerProps.dragging, id = containerProps.id;
    ...
    var handleDrag = function(e) {
          ...
          row: widgetSelfLine.row.map(function(i, index) {
            ...
            if (match !== null) {
              if (index === 0) {
                ...
                newTop = Math.floor(match - h2.value / 2);
              } else if (index === 2) {
                newTop = Math.floor(match - h2.value);
              }
            }
            return match;
          }).filter(function(i) {
      ...
      emit2("dragging", { x: setLeft(newLeft), y: setTop(newTop) });
    };
    ...
    vue_1.watch(dragging, function(cur, pre) {
      if (!pre && cur) {
        emit2("drag-start", { x: x.value, y: y.value });
        setEnable(true);
        setDragging(true);
      } else {
        emit2("drag-end", { x: x.value, y: y.value });
        setDragging(false);
      }
    });
    vue_1.onMounted(function() {
  ...
  function initResizeHandle(containerProps, limitProps, parentSize, props, emit2) {
  ...
  (function(exports) {
    ...
    var VueDraggableResizable = vue_1.defineComponent({
      ...
      setup: function(props, _a) {
        var emit2 = _a.emit;
        var containerProps = hooks_1.initState(props, emit2);
        ...
        hooks_1.initDraggableContainer(containerRef, containerProps, limitProps, vue_1.toRef(props, "draggable"), emit2, containerProvider, parentSize);
        var resizeHandle = hooks_1.initResizeHandle(containerProps, limitProps, parentSize, props, emit2);
...
const _imports_0 = "data:image/svg+xml,%3csvg%20width='42'%20height='16'%20viewBox='0%200%2042%2016'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M1%207C0.447715%207%200%207.44772%200%208C0%208.55228%200.447715%209%201%209V7ZM41.7071%208.70711C42.0976%208.31658%2042.0976%207.68342%2041.7071%207.29289L35.3431%200.928932C34.9526%200.538408%2034.3195%200.538408%2033.9289%200.928932C33.5384%201.31946%2033.5384%201.95262%2033.9289%202.34315L39.5858%208L33.9289%2013.6569C33.5384%2014.0474%2033.5384%2014.6805%2033.9289%2015.0711C34.3195%2015.4616%2034.9526%2015.4616%2035.3431%2015.0711L41.7071%208.70711ZM1%209H41V7H1V9Z'%20fill='%23E8E7E8FF'/%3e%3c/svg%3e";
const _withScopeId$1 = (n) => (pushScopeId("data-v-c8a743da"), n = n(), popScopeId(), n);
const _hoisted_1$5 = { id: "wrapper" };
const _hoisted_2$5 = { style: { "display": "flex" } };
const _hoisted_3$4 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("img", {
  src: "https://cdn.builder.io/api/v1/image/assets/TEMP/cebe227e5ca98f52fa0c118e2b42ba0ce362bcf3f9ee034f2d2b0267005f4cbd?apiKey=64de9059607140be8c9d5acd9f2dfd62&",
  alt: "Fighter Kolosova Irina",
  class: "fighter-image"
}, null, -1));
const _hoisted_4$2 = { class: "name" };
const _hoisted_5 = { class: "title-small" };
const _hoisted_6 = { class: "title-small" };
const _hoisted_7 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("div", { style: { "overflow": "hidden" } }, [
  /* @__PURE__ */ createBaseVNode("span", {
    class: "body-medium",
    style: { "white-space": "nowrap", "text-overflow": "ellipsis", "color": "rgba(9, 94, 193, 1)" }
  }, 'Школа Кекушин каратэ')
], -1));
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  __name: "CardFigtherItem",
  props: {
    fighter: {}
  },
  setup(__props) {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$5, [
        createBaseVNode("div", _hoisted_2$5, [
          ...
          createBaseVNode("div", _hoisted_4$2, [
            createBaseVNode("span", _hoisted_5, toDisplayString(props.fighter.getFirstName()), 1),
            createBaseVNode("span", _hoisted_6, toDisplayString(props.fighter.getLastName()), 1)
          ])
        ]),
        _hoisted_7
      ]);
...
const CardFigtherItem = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-c8a743da"]]);
const viewConfig = reactive({
  blockHeight: 230,
  unionWidth: 70,
  widthFightPairCard: "auto",
  moveDelta: 50,
  widthMenu: 212
});
const configInit = function() {
  const windowsWidth = window.innerWidth;
  if (windowsWidth < 450) {
    viewConfig.blockHeight = 170;
    viewConfig.unionWidth = windowsWidth * 0.09;
    viewConfig.widthFightPairCard = windowsWidth * 0.44 - 14 + "px";
    viewConfig.widthMenu = windowsWidth * 0.44 - 14;
    viewConfig.moveDelta = windowsWidth * 0.53;
    return;
  }
  viewConfig.blockHeight = 230;
  viewConfig.unionWidth = 70;
};
configInit();
const _withScopeId = (n) => (pushScopeId("data-v-0bd74578"), n = n(), popScopeId(), n);
const _hoisted_1$4 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "circle-top" }, null, -1));
const _hoisted_2$4 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "circle-bottom" }, null, -1));
const _hoisted_3$3 = [
  _hoisted_1$4,
  _hoisted_2$4
];
const _hoisted_4$1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", {
  class: "label-medium",
  style: { "position": "absolute", "top": "50%", "left": "50%", "transform": "translate(-50%, -50%)" }
}, " Бой №1 ", -1));
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  __name: "FightPairCard",
  props: {
    fight: {},
    index: {},
  ...
  setup(__props) {
    ...
    function calculateHeight(index) {
      return Math.pow(2, index - props.current_section_index) * viewConfig.blockHeight;
    }
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: "fightPair",
        style: normalizeStyle("height:" + calculateHeight(props.index) + "px;")
      }, [
        props.index > 0 ? (openBlock(), createElementBlock("div", {
          key: 0,
          style: normalizeStyle([{ "height": "50%" }, "width: " + (unref(viewConfig).unionWidth / 7 * 4 - 2) + "px;"]),
          class: "union"
        }, _hoisted_3$3, 4)) : createCommentVNode("", true),
        props.index > 0 ? (openBlock(), createElementBlock("img", {
          key: 1,
          src: _imports_0,
          alt: "logo",
          style: normalizeStyle("width: " + unref(viewConfig).unionWidth / 7 * 3 + "px")
        }, null, 4)) : createCommentVNode("", true),
        props.index < 1 ? (openBlock(), createElementBlock("div", {
          key: 2,
          style: normalizeStyle("width: " + unref(viewConfig).unionWidth / 7 * 3 + "px")
        }, null, 4)) : createCommentVNode("", true),
        createBaseVNode("div", {
          class: "fighters",
          style: normalizeStyle({ width: unref(viewConfig).widthFightPairCard })
        }, [
          _hoisted_4$1,
          createVNode(CardFigtherItem, {
            fighter: props.fight.getFighter1()
          }, null, 8, ["fighter"]),
          createVNode(CardFigtherItem, {
            fighter: props.fight.getFighter2()
          }, null, 8, ["fighter"])
        ], 4)
      ], 4);
    };
...
const FightPairCard = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-0bd74578"]]);
const _hoisted_1$3 = {
  class: "nav_puli_box nav_puli_active",
  id: "nav_puli"
};
const _hoisted_2$3 = /* @__PURE__ */ createStaticVNode('<div data-v-f3ccc5ab><div class="match-number" data-v-f3ccc5ab>Пуля 2</div><div class="match-location" data-v-f3ccc5ab>Tатами №12</div><div class="match-details" data-v-f3ccc5ab><img src="https://cdn.builder.io/api/v1/image/assets/TEMP/0388d3419253cbb171d0da184fcfc66a1e2d57e0c656977efe8a377f6ed88888?apiKey=64de9059607140be8c9d5acd9f2dfd62&amp;" alt="" class="match-icon" data-v-f3ccc5ab><div class="match-info" data-v-f3ccc5ab>12-13 • 22-32кг</div></div></div>', 1);
const _hoisted_3$2 = [
  _hoisted_2$3
];
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const activeTourneyIndex = ref(1);
    const props = __props;
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        createBaseVNode("div", {
          class: "puli__container",
          style: normalizeStyle("width: " + unref(viewConfig).widthMenu + "px;")
        }, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(props.tourneys, (item) => {
            return openBlock(), createElementBlock("div", {
              id: "match",
              class: normalizeClass(item.getIndex() === activeTourneyIndex.value ? "active-match" : "match")
            }, _hoisted_3$2, 2);
          }), 256))
        ], 4)
      ]);
...
const TourneyMenu = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-f3ccc5ab"]]);
const _hoisted_1$2 = { id: "res_slide_box" };
const _hoisted_2$2 = { class: "parent" };
const _hoisted_3$1 = { class: "event" };
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  __name: "TourneyMobile",
  props: {
    events: {}
  },
  setup(__props) {
    const props = __props;
    const currentMainSectionIndex = ref(0);
    const menuShow = ref(true);
    const positionX = ref(1e3);
    const isDraggable = ref(false);
    const wrapperElement = ref(null);
    const innerWrapperElement = ref(null);
    const slideBoxHeight = ref("auto");
    const innerWrapperStyle = ref({});
    let swipeX = 0;
    ...
    const swipeRight = function() {
      if (currentMainSectionIndex.value === 0 && menuShow.value)
        return;
      if (currentMainSectionIndex.value === 0) {
        menuShow.value = true;
        positionX.value += viewConfig.widthMenu + 15;
        return;
      }
      positionX.value += viewConfig.moveDelta + 1;
      currentMainSectionIndex.value--;
    };
    const swipeLeft = function() {
      if (currentMainSectionIndex.value === props.events.length - 2)
        return;
      if (currentMainSectionIndex.value === 0 && menuShow.value) {
      ...
      positionX.value -= viewConfig.moveDelta;
      currentMainSectionIndex.value++;
    };
    onMounted(() => {
      addEventListener("touchstart", (e) => swipeX = e.changedTouches[0].clientX);
      addEventListener("touchend", (e) => {
        const deltaX = e.changedTouches[0].clientX - swipeX;
        if (deltaX < -50) {
          swipeLeft();
        } else if (deltaX > 50) {
          swipeRight();
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        createBaseVNode("div", _hoisted_2$2, [
          createVNode(unref(Vue3DraggableResizable), {
            style: normalizeStyle(isDraggable.value ? "" : "transition: all 0.5s ease;"),
            x: positionX.value,
            "onUpdate:x": _cache[0] || (_cache[0] = ($event) => positionX.value = $event),
            draggable: false,
            disabledY: true,
            disabledH: true,
            parent: true,
            ...
            default: withCtx(() => [
              createBaseVNode("div", {
                ...
                ref: wrapperElement,
                style: normalizeStyle("height:" + slideBoxHeight.value)
              }, [
                createBaseVNode("div", {
                  class: "d-flex",
                  ref_key: "innerWrapperElement",
                  ref: innerWrapperElement,
                  style: normalizeStyle([innerWrapperStyle.value, { "transition": "height 0.5s ease" }])
                }, [
                  createBaseVNode("div", {
                    class: "menu-wrapper",
                    style: normalizeStyle("width:" + unref(viewConfig).widthMenu + "px")
                  }, [
                    createVNode(TourneyMenu, { tourneys: unref(tourneys) }, null, 8, ["tourneys"])
                  ], 4),
                  (openBlock(true), createElementBlock(Fragment, null, renderList(props.events, (event, index) => {
                    return openBlock(), createElementBlock("section", _hoisted_3$1, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(event.getFights(), (fight) => {
                        return openBlock(), createElementBlock("div", null, [
                          createVNode(FightPairCard, {
                            fight,
                            index,
                            current_section_index: currentMainSectionIndex.value
                          }, null, 8, ["fight", "index", "current_section_index"])
                        ]);
                      }), 256))
                    ]);
                  }), 256))
...
const TourneyMobile = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-51de8d56"]]);
const _hoisted_1$1 = { id: "wrapper" };
const _hoisted_2$1 = {
  class: "d-flex",
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("div", _hoisted_2$1, [
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(events), (event, index) => {
            return openBlock(), createElementBlock("section", _hoisted_4, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(event.getFights(), (fight) => {
                return openBlock(), createElementBlock("div", null, [
                  createVNode(FightPairCard, {
                    fight,
...
const TourneyDesktop = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-8021256e"]]);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return isMobile ? (openBlock(), createElementBlock("div", _hoisted_1, [
        createVNode(TourneyMobile, { events: unref(events) }, null, 8, ["events"])
      ])) : (openBlock(), createElementBlock("div", _hoisted_2, [
        createVNode(TourneyDesktop, { events: unref(events) }, null, 8, ["events"])
      ]));
    };
  }
});
