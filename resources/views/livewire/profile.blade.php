<div>
    <main class="main">
        <div class="container container_profi">
            ...
            <section class="hide-block tournament-notification">
                <div class="notification-content">
                    <p class="notification-message">
                        Ваш тренер записал вас на турнир "{{$tournament->name}}" {{$tournament->date}}
                    </p>
                    <div class="notification-action">
                        <button class="hide-button decline-button" wire:click="refuseTournament({{ $tournament->id }})">Отказаться</button>
                    </div>
                </div>
            </section>
            @endforeach
...
{{--            <section class="hide-block success-message">--}}
{{--                <div class="success-message-content">--}}
{{--                    <p class="success-message-text">Вы успешно пополнили счет</p>--}}
{{--                    <div class="success-message-button">--}}
{{--                        <button class="hide-button success-message-button-text">Ок</button>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </section>--}}
...
{{--            <section class="hide-block insurance-alert">--}}
{{--                <div class="insurance-alert-content">--}}
{{--                    <p class="insurance-alert-message">--}}
{{--                        У вас недействительна или истек срок годности страховки--}}
{{--                    </p>--}}
{{--                    <div class="insurance-alert-action">--}}
{{--                        <button class="hide-button insurance-alert-button">Исправлю</button>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </section>--}}
