        ...
        <section class="students_header none_mobile" style="width: 100%;">
            <div class="container">
                <div class="input-container">
                    <input for="email-input" wire:model="emails" class="email-input" placeholder="Добавьте почты тренеров, через запятую"></input>
...
@foreach($coaches as $coach)
                    <article class="athlete-item">
                        ...
                        <p class="athlete-rank">{{$coach->ky}}</p>
...
{{--                        <p class="athlete-score">15 / 8</p>--}}
                        <div class="athlete-delete">
                            ...
                            <a wire:click.prevent="deleteCoach({{$coach->id}})" class="delete-text">Удалить</a>
                        </div>
                    </article>
                    @endforeach
                </div>
                ...
                <div class="user-info">
                    ...
                    <div class="user-details">
                        ...
                        <div class="user-stats">
                            ...
                            <span class="user-weight">{{$coach->weight}}кг</span>
                            <span class="user-rank">{{$coach->ky}}</span>
